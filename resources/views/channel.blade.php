...
@foreach($channels as $channel_data)
                <article class="col-md-4 video-item">
                    ...
                    <a href="/openchannel/{{ $channel_data->channel_name }}">
                        <img style="border-radius: 15px;" width="350px" height="245px" src='/img/channel.png'>
                    </a>

                    <h3 class="video-title" style="text-align: center; font-size: 25px;font-family: 微軟正黑體;">
                        <a href="/test3"> {{$channel_data->channel_name}}</a>
                    </h3>
