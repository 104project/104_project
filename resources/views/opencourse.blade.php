...
@section('category_well')
    ...
    <div class="well" style="margin: 30px auto; width: 80%;border: 5px solid #d3d3d3;text-align:center;font-size: 25px;line-height: 50px;">

        <div class="channel" style="margin-bottom: 10px;font-weight: 900;">
            <iframe src="https://image.flaticon.com/icons/svg/167/167734.svg" width="40" height="35"
                    style="margin-right:8px;border: unset;">
        ...
        <div class="channelcontent"  style="font-weight: 600;">
            「開放式頻道」計劃旨在集合社會力量，創建一個共享教育的平台。<br/>
            「共享」的意思，就是希望可以透過平台，共同享用珍貴的教學資源。<br/>
            透過這個平台，讓每個人都有機會分享屬於自己的知識，<br/>並且不帶任何利益的社會交換，
            改變學生各自買教科書的傳統教學模式，<br/>並藉此作為推動並過渡至家長可負擔的電子學習模式。<br/>
            只要是有需求的教師就能上平台搜尋，<br/>並借用其他老師陳述觀點的影片進行遠距觀課或教學，<br/>而學生與家長也能按照個人進度補課或補充知識。<br/>
        </div>



        <div class="channelbutton" style="width: 25%;height: 3%;margin:20px auto;">
            <div class="channelbtnleft" style="float: left;">
                    ...
                    <div class="pull-right list-view-change">
                        ...
                        <div class="theme-popover">
                            <div class="theme-poptit">
                                ...
                                <h3 style=" font-family: 微軟正黑體; font-weight: bold;" >新增頻道</h3>
                            </div>
                            ...
                            <div class="theme-popbod dform">
                                ...
                                <form class="theme-signin" name="add_video" action="/openchannel/add" method="post" >
                                    <ol>

                                        <li style="padding-left:0px;">
                                            <strong>頻道名稱：</strong>
                                            <input class="ipt" type="text" name="channel_name"  placeholder="channel_name"/>
                                        </li>
                                        <li style="padding-left:0px;">
                                            <strong>標籤顏色：</strong>
            ...
            <div class="channelbtnright" style="float: right;">
                <button class="layui-btn" onclick="location.href='/openchannel/channels'">進入頻道</button>
            </div>
        </div>
    </div>
