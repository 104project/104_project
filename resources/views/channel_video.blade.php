            ...
            <!-- Video film view - center -->
                <div class="row" style="margin: 0 auto;">
                                ...
                                <div class="row  videos-list" style="display: flex;flex-wrap: wrap; ">
                                    @foreach($SimilarVideos as $similarVideos)
                                        <article class="col-md-6  video-item">
                                            <a href="/openchannel/{{ $similarVideos->channel_name }}/{{ $similarVideos->id }}" class="video-prev video-prev-small">
                                            ...
                                            <p class="button-full"><a  href="/video/{{ $similarVideos->channel_name  }}/{{ $similarVideos->id }}" class="btn btn-theme btn-green" style="background-color: #006dcc;     font-size: 18px;"><i class="fa fa-arrow-circle-right"></i> 立即前往</a></p>
                                        </article>
                                    @endforeach
                                </div>
                    ...
                    <aside class="col-md-4" >
                        ...
                        <p class="button-full buttons-margin-horizontal" ><a href="/openchannel/{{$video->channel_name}}" class="btn btn-theme btn-green"><i class="fa fa-arrow-circle-left"></i> 返回頻道</a></p>
